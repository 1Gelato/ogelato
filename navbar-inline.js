...
(function() {
    ...
    function initNavbar() {
        ...
        // Déterminer si on est dans le dossier produits/
        const isInProduitsFolder = currentPath.split('/').includes('produits');
        const pathPrefix = isInProduitsFolder ? '../' : '';
        ...
        <style id="navbar-styles">
            ...
            /* Override pour le dernier dropdown qui doit s'aligner à droite */
            ...
            <nav>
                ...
                <ul class="nav-links">
                    <li class="nav-dropdown">
                        ...
                        <div class="dropdown-menu glass-dropdown">
                            ...
                            <div class="dropdown-section" style="grid-column: 1 / -1; border-top: 2px solid rgba(232, 74, 95, 0.1); padding-top: 1rem; margin-top: 0.5rem;">
                                ...
                                <a href="${pathPrefix}machines-glaces.html" class="dropdown-item" style="color: #E84A5F; font-weight: 600;">→ Toutes les machines</a>
                            </div>
                        </div>
                    </li>
                    <li class="nav-dropdown">
                        ...
                        <div class="dropdown-menu glass-dropdown">
                            ...
                            <div class="dropdown-section">
                                <div class="dropdown-title">Voir Tout</div>
                                <a href="${pathPrefix}machines-granites.html" class="dropdown-item" style="color: #E84A5F; font-weight: 600;">→ Toutes les machines</a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-dropdown">
                        ...
                        <div class="dropdown-menu glass-dropdown">
                            <div class="dropdown-section">
                                <div class="dropdown-title">Bonnes Affaires</div>
                                <a href="${pathPrefix}occasions-glaciers.html" class="dropdown-item">Occasions Glaciers</a>
                                <a href="${pathPrefix}index.html#offers" class="dropdown-item">Offres du mois</a>
                            </div>
                            <div class="dropdown-section">
                                <div class="dropdown-title">Packs & Promos</div>
                                <a href="${pathPrefix}index.html#offers" class="dropdown-item">Pack TG3 -3000€</a>
                                <a href="${pathPrefix}index.html#offers" class="dropdown-item">Carte Membre -15%</a>
                            </div>
                        </div>
                    </li>
        ...
        // Attendre un peu pour être sûr que le DOM est mis à jour
        setTimeout(function() {
            // Mobile menu toggle
